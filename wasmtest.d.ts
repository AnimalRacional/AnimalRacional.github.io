...
export function test_arr(name: Uint8Array, size: number, modif: ImageMod): Uint8Array;
...
export interface InitOutput {
  ...
  readonly test_arr: (a: number, b: number, c: any, d: number, e: number) => [number, number];
